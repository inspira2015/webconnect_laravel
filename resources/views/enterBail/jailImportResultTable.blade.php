    ...
    @foreach($jailRecords as $key=>$value)
        <tr>
            ...
            <td height="20" width="60">
                <input name="index_no[]" type="text" size="25" class="form-control form-control-sm"  value="<?php echo $value->index_number; ?>">
            </td>
            <td height="20" width="25">
                <input name="index_year[]" size="3" class="form-control form-control-sm" value="<?php echo $value->index_year; ?>">
            </td>
