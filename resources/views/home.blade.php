...
<div id="content">
    ...
    <div style="width:100%; background-image:url({{ asset('images/cashbail/menu_right_25.jpg') }}); background-position:top right; background-repeat:no-repeat">
        ...
        <table width="498" border="0" cellpadding="0" cellspacing="5">
            ...
            <tr>
                <td height="21" style="background-image:url({{ asset('images/cashbail/cashbailbuttons_06.jpg') }}); background-position: left top; background-repeat:no-repeat">
            ...
            <tr>
                <td height="21" style="background-image:url({{ asset('images/cashbail/cashbailbuttons_08.jpg') }}); background-position: left top; background-repeat:no-repeat">
            ...
            <tr>
                <td height="21" style="background-image:url({{ asset('images/cashbail/cashbailbuttons_10.jpg') }}); background-position: left top; background-repeat:no-repeat">
            ...
            <tr>
                <td height="21" style="background-image:url({{ asset('images/cashbail/cashbailbuttons_12.jpg') }}); background-position: left top; background-repeat:no-repeat">
            ...
            <tr>
                <td height="21" style="background-image:url({{ asset('images/cashbail/cashbailbuttons_14.jpg') }}); background-position: left top; background-repeat:no-repeat">
            ...
            <tr>
                <td height="21" style="background-image:url({{ asset('images/cashbail/cashbailbuttons_16.jpg') }}); background-position: left top; background-repeat:no-repeat">
